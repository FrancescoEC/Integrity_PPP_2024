...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nsol=size(solution,1); nref=size(station,1);
if nsol==0
...
for i=1:nsol
    ...
    pva_ref(i,:)=[week,sow,station,zeros(1,3),zeros(1,3)];
%     [station(i).week,station(i).sow,station(i).pos,...
%                   station(i).vel,station(i).att];
end
...
if flag==1 || flag==4
    ...
    if k==0
        error('The position solution or station truth does not exist!!!');
    end
    if k<nsol
...
elseif flag==2
    ...
    if k==0
        error('The velocity solution or station truth does not exist!!!');
    end
    if k<nsol
...
elseif flag==3
    ...
    if k==0
        error('The attitude solution or station truth does not exist!!!');
    end
    if k<nsol
