...
File_name_GPS='LEOGNSS_GPS_65_55_only_new.yuma';
File_name_GAL='LEOGNSS_Galileo_65_55_only_new.yuma';
...
Inclination=[85,65,45,5];
NumberOfSat=[99,200,66,54];
...
colors = colororder;
firstLineColor = colors(1,:);
plot(LEO_PNT_T.timeHistoryTotal(1:Window,1),Index_tot(b(1:44)).*acStatsAllTime(1:Window,b(1:44)), ...
    Color=firstLineColor,LineWidth=1)
...
if subset==1
Set_Satelliite=Index_tot(any(acStatsAllTime(1:120,:)));
elseif subset==2
Set_Satelliite=Index_tot(any(acStatsAllTime(1:120,:)));
QQQ=sum(~isnan(acStatsAllTime(1:120,Set_Satelliite))*60);
Set_Satelliite=Set_Satelliite(QQQ>500);
else
   Set_Satelliite=Index_tot(b(1:60));
end
