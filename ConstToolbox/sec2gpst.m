...
%
% Utility function to convert gps time in seconds to a
% 2-element matrix of gps_week and gps_sec from beginning of week
% The GPS time reference frame of measuring either from the GPS week
% rollover, or from the start of GPS time, is preserved.
%
